...
<div class="container">
    <div>
        ...
        <nuxt-link class="inline-block py-4 px-8 mr-6 leading-none text-white bg-indigo-500 hover:bg-indigo-600 rounded shadow" v-for="locale in availableLocales" :key="locale.code" :to="(locale.code) + '/insertpoc'" data-cy="start-button">{{ $t('getstarted') }}</nuxt-link>
